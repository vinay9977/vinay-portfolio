...
import { Code, Github, ExternalLink, Zap, Globe, Filter } from 'lucide-react';
          ...
          {filteredProjects.map((project, idx) => (
            ...
            >
              <div className="grid lg:grid-cols-5 gap-0">
                ...
                <div className="lg:col-span-2 relative overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50 p-8 flex items-center justify-center">
                  {/* Placeholder for project screenshot */}
                  <div className="relative w-full aspect-video bg-white rounded-xl shadow-lg border-2 border-gray-200 flex items-center justify-center overflow-hidden group-hover:scale-105 transition-transform duration-300">
                    {/* Replace with actual screenshot */}
                    <div className="text-center p-8">
                      <Code className="w-24 h-24 mx-auto mb-4 text-blue-600" />
                      <p className="text-gray-500 font-medium">Project Screenshot</p>
                      <p className="text-gray-400 text-sm mt-2">Add screenshot or demo GIF here</p>
                    </div>
                    {/* When you have screenshots, use: */}
                    {/* <img src="/path/to/screenshot.png" alt={project.name} className="w-full h-full object-cover" /> */}
                  </div>
